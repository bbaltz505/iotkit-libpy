...
class TestDataMgmnt(unittest.TestCase):
    ...
    def test_query1(self): 
        ...
        print results
        # results[0] - data for device='Junko'; points[0] - 1st returned data set
    ...
    def test_advquery1(self):    
        ...
        self.assertEqual(float(results["data"][0]["components"][0]["samples"][0][1]), data[0][1])
        self.assertEqual(float(results["data"][0]["components"][0]["samples"][1][1]), data[1][1])
